# Ensure the MySQL healthcare database is set as the default database.
# Ensure the silver_ddl file has been exeuted.
# Create tables in healthcare database with data from the silver level tables.
# Data has been transformed further from the silver level tables.  Tables created from this fill
# will not have any level prefix.

### Create final tables after all trasformations have been implemented in the silver level.

# create table dmission_type:
